        ...
        <div id="projects">
            ...
            <div className='ProjectList'>
                ...
                >
                    ...
                    <a href="/ticketbot"  ><div className='ProjectListItem3'><div className='projectPic' id="kideitem">Ticket bot</div><div className='ProjectListItemText3'><p>Practicing web automation and REST api usage by creating an automated ticket buying app. Then using Flutter to learn about mobile development.</p></div></div></a>
