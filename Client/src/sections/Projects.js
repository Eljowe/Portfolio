    ...
    return(
        <div id="projects">
            ...
            <div className='ProjectList'>
                ...
                <a href="/ticketbot"  ><div className='ProjectListItem'><div className='projectPic' id="kideitem">REST, Flutter, and stuff</div><div className='ProjectListItemText'><p>Practicing web automation and REST api usage by creating an automated ticket buying app. Then using Flutter to test mobile development.</p></div></div></a>
